...
# Dealing with NA's ------------------------------------------------------------
    ...
    # Phone
    #categroical variabel so I will impute with the mode
...
# Other Data Quality Issues ----------------------------------------------------
    ...
    # Remove the auto-generated row name column
        churn <- churn [-1]
...
# PCA --------------------------------------------------------------------------
    ...
    # Plotting PCA
      plot(pca, type = 'l')
      Scree_plot <- fviz_eig(pca, choice = "eigenvalue", addlabels = TRUE, ncp = 11) +
